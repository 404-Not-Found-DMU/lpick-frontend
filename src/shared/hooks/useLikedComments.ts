...
type UseLikedCommentsParams = PaginationParams;

interface UseLikedCommentsReturn {
 ...
 */
export const useLikedComments = (params: UseLikedCommentsParams = {}): UseLikedCommentsReturn => {
  ...
  const fetchComments = useCallback(async () => {
    ...
    try {
      ...
      console.error('Failed to fetch liked comments:', err);
