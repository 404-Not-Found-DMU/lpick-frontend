...
const LoginCard = () => {
  ...
  return (
    <div className="w-full max-w-[320px] sm:max-w-[360px] lg:max-w-[420px]">
      {/* 로그인 카드 */}
      <div className="animate-fade-in animation-delay-300 mb-10 rounded-2xl border border-white/20 bg-white/80 p-5 shadow-2xl backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-800/80 sm:p-6 lg:mb-0 lg:p-8">
