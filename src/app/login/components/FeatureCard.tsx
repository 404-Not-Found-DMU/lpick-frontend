...
const FeatureCard = ({ icon, title, description, className }: FeatureCardProps) => (
  ...
  >
    <div className="mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-lavender-100 dark:bg-lavender-900/30 sm:mb-3 sm:h-10 sm:w-10 lg:mb-4 lg:h-12 lg:w-12">
      {icon}
    </div>
