...
export default function WikiOtherPage({ params }: WikiPageProps) {
  ...
  const wikiMeta = {
    ...
    contributors: 8,
    relatedPages: [
      { title: "블루스", slug: "other/blues" },
      { title: "컨트리 음악", slug: "other/country-music" },
      { title: "1950년대 음악", slug: "other/1950s-music" },
      { title: "1960년대 음악", slug: "other/1960s-music" },
      { title: "음악 장르", slug: "other/music-genres" },
    ],
  }
          ...
          <div className="w-full lg:w-3/4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6">
              <div className="flex items-center mb-2">
                <Badge className="bg-orange-500/10 text-orange-500 font-normal mr-2">{wikiMeta.category}</Badge>
                ...
                <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                  <ol className="list-decimal list-inside space-y-2">
                    {textBlocks.map((block, index) => (
                      <li key={block.id}>
                        <a href={`#${block.id}`} className="text-orange-500 hover:underline">
                          {index + 1}. {block.title}
                        </a>
                      </li>
                    ))}
          ...
          <div className="w-full lg:w-1/4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6">
              ...
              <ul className="space-y-2">
                {wikiMeta.relatedPages.map((page) => (
                  <li key={page.slug}>
                    <Link href={`/wiki/${page.slug}`} className="flex items-center text-orange-500 hover:underline">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/wiki/other/pop-music" className="block group">
                    <h4 className="text-gray-800 dark:text-gray-200 group-hover:text-orange-500 font-medium">팝 음악</h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400">30분 전</p>
                  </Link>
                </li>
                <li>
                  <Link href="/wiki/other/jazz" className="block group">
                    <h4 className="text-gray-800 dark:text-gray-200 group-hover:text-orange-500 font-medium">재즈</h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400">2시간 전</p>
                  </Link>
                </li>
                <li>
                  <Link href="/wiki/other/classical-music" className="block group">
                    <h4 className="text-gray-800 dark:text-gray-200 group-hover:text-orange-500 font-medium">클래식 음악</h4>
